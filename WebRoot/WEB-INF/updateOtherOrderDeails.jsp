...
<div class="form-group" style="margin-bottom: 0px;">
									...
									<div class="form-group" style="margin-bottom: 0px;">
										<div
											style="height: 38px; text-align: left; width: 30%; display: inline-block;white-space: nowrap; color: #606265;">Preferred
											Operator:</div>
									...
									<div class="form-group" style="border-bottom: solid 1px #d2c3c3;">
										...
										<div
											...
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 60%;">Package:</div>
												<input type="checkbox" id="inlineCheckbox1"  ${work_order.one_point1==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="one_point1">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 60%;">Parts deliver:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point2==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="one_point2">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 60%;">Pick up:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point3==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="one_point3">
											</div>
										</div>
										...
										<div
											style="height: 38px; width: 100%; display: inline-block; color: #606265; padding-left: 3%;">
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 60%;">Antirust:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point4==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="one_point4">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 60%;">Mechanic Support:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point5==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="one_point5">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 60%;">Scrap:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point6==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="one_point6">
											</div>
										</div>
