			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1.8vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
						<a href="/EPD/celianggongju/findOneCe.do?id=1">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
						<a href="/EPD/celianggongju/findOneCe.do?id=2">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=3">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=4">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1.8vw;display: inline-block;margin-top: 1.8vh">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=5">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=6">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=7">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=8">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1.8vw;display: inline-block;margin-top: 1.8vh">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=9">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=10">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=11">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=12">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1.8vw;display: inline-block;margin-top: 1.8vh">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=13">
						<c:choose>
			...
			<div style="background: white;width:23%;height: 8.2vh;margin-left: 1vw;display: inline-block;">
				<table style="padding-top:1.8vh;display: block;margin-left: 0.8vw">
					<tr>
						...
						<td style="width:4vw">
<a href="/EPD/celianggongju/findOneCe.do?id=14">
						<c:choose>
