								 ...
								 <div class="form-group" style="margin-bottom:0px;">
								  ...
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">点检实施者:</div>
								       <input disabled="true" type="text"style="width:50%;margin-left:5%;display: inline-block;" class="form-control" id="username" name="username" value="${year_check.username}">
								  </div>
								   <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">检查日期:</div>
								 		<input disabled="true" type="text" class="form-control layui-input" style="width:50%;margin-left:5%;display: inline-block;" id="test1" name="check_time" placeholder="yyyy-MM" value="${year_check.year}"/>
								  </div>
							</div>
							...
							<div class="col-md-8 col-lg-8 col-xl-8 col-sm-8" style="min-height:30px;border:saolid 1px;">
								 <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">油箱进油滤清更换:</div>
								     <select disabled="true" id="y_01" name="y_01" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${year_check.y_01==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">液压油液位检查，缺少添加:</div>
								     <select disabled="true" id="y_02" name="y_02" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                              <option ${year_check.y_02==1?'selected':''} value='1'>√</option>
                                               ...
                                               <option ${year_check.y_02==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
								  
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">油箱换油（2年一次）:</div>
								     <select disabled="true" id="y_03" name="y_03" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${year_check.y_03==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">油箱清洗（2年一次）:</div>
								     <select disabled="true" id="y_04" name="y_04" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
