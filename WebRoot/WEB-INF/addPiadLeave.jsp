						...
						<div class="row" style="margin-left:0px;margin-right:0px;margin-top:30px;">
							...
							<div class="col-md-8 col-lg-8 col-xl-8 col-sm-8" style="min-height:30px;border:saolid 1px;">
								 <div class="form-group">
								    ...
								    <c:if test="${role=='administrator'}">
								        <select id="nameId" name="bench_name" style="width:40%;margin-left:2%;display: inline-block;" class="form-control">
								...
								<!--动态添加数据  --> 
								 <div class="form-group">
									...
									<input style=" display: inline-block;width:40%;margin-left:2%;" readonly="" class="time-input form-control form_datetime" 
											name="tradeTime" id="tradeTimeStart" size="12" type="text" placeholder="开始时间"
									...
									<input style=" display: inline-block;width:40%;margin-left:2%;" readonly="" class="time-input form-control form_datetime form_datetime11" 
											name="tradeTime" id="tradeTimeEnd" size="12" type="text" placeholder="结束时间"
											data-date-format="yyyy-mm-dd HH:mm"/>
								</div> 
 								<div class="form-group" style="height: 143px;">
									<textarea id="remark" class="form-control" style=" display: inline-block;width:95%;height:143px;" placeholder="请输入原因" maxlength="200"></textarea>
								</div> 
							<!--动态添加数据结束  --> 	
							</div>
							<div class="col-md-2 col-lg-2 col-xl-2 col-sm-2" style="min-height:30px;"></div>
