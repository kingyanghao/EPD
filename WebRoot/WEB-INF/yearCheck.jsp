								  ...
								  <div class="form-group" style="margin-bottom:0px;">
								   ...
								   <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">检查日期:</div>
								 		<input type="text" class="form-control layui-input" style="width:50%;margin-left:5%;display: inline-block;" readonly="" id="test1" name="year" placeholder="yyyy">
								  </div>
							</div>
