						...
						<input readonly 
							...
							<div class="row"
								...
								<div class="col-md-5 col-lg-5 col-xl-5 col-sm-5"
									...
									<div class="form-group" style="margin-bottom: 0px;">
										<div
											style="height: 38px; text-align: left; width: 30%; display: inline-block; white-space: nowrap; color: #606265;">Plan work hours:</div>
										<input id="work_hours" name="work_hours" readonly
											style="width: 60%; margin-left: 5%;white-space: nowrap; display: inline-block;"
									...
									<div class="form-group" style="margin-bottom: 0px;">
										<div
											style="height: 38px; text-align: left; width: 30%; display: inline-block; color: #606265;">Preferred
											Operator:</div>
											<input id="part_quantity" name="part_quantity" readonly
											style="width: 60%; margin-left: 5%; white-space: nowrap;display: inline-block;"
									...
									<div class="form-group" style="border-bottom: solid 1px #d2c3c3;">
										...
										<div
											...
											<div style="width: 20%; display: inline-block;">
												...
												<input type="checkbox" id="inlineCheckbox1" ${work_order.three_point1==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="three_point1">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">PLV F:</div>
												<input type="checkbox" id="inlineCheckbox1"  ${work_order.three_point2==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="three_point2">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">PCV F:</div>
												<input type="checkbox" id="inlineCheckbox1"  ${work_order.three_point3==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
									...
									<div class="form-group" style="border-bottom: solid 1px #d2c3c3;">
										...
										<div
											...
											<div style="width: 20%; display: inline-block;">
												...
												<input type="checkbox" id="inlineCheckbox1" ${work_order.eight_point3==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="eight_point3">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">Hardness test:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.eight_point4==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
