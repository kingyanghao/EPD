							...
							<div class="col-md-4 col-lg-4 col-xl-4 col-sm-4" style="min-height:30px;border:saolid 1px;">
								 <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">台架电源:</div>
								     <select disabled="true" id="power_supply" name="power_supply" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${daily_check.power_supply==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  ...
								  <div class="form-group">
								     ...
								     <select disabled="true" id="test_oil_level" name="test_oil_level" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${daily_check.test_oil_level==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">目视</span></div>
								  ...
								  <div class="form-group">
								     ...
								     <select disabled="true" id="hydraulic_oil_level" name="hydraulic_oil_level" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${daily_check.hydraulic_oil_level==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">目视</span></div>
								    	<div>点检标准：<span style="margin-left:5%;">无PLC报警提示</span></div>
								   ...
								   <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;position: relative;top: 10px;">压缩空气<br/>气源压力:</div>
								     <select disabled="true" id="air_source_pressure" name="air_source_pressure" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                              <option ${daily_check.air_source_pressure==1?'selected':''} value='1'>√</option>
                                               ...
                                               <option ${daily_check.air_source_pressure==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">目视</span></div>
								  ...
								  <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">冷却水:</div>
								     <select disabled="true" id="water_coolant" name="water_coolant" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                              <option ${daily_check.water_coolant==1?'selected':''} value='1'>√</option>
                                               ...
                                               <option ${daily_check.water_coolant==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">目视</span></div>
								  ...
								  <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">工控机:</div>
								     <select disabled="true" id="industrial_pc" name="industrial_pc" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                              <option ${daily_check.industrial_pc==1?'selected':''} value='1'>√</option>
                                               ...
                                               <option ${daily_check.industrial_pc==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">目视</span></div>
							...
							<div class="col-md-4 col-lg-4 col-xl-4 col-sm-4" style="min-height:30px;border:saolid 1px;">
								  <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">光栅，安全门:</div>
								     <select disabled="true" id="security_door" name="security_door" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                              <option ${daily_check.security_door==1?'selected':''} value='1'>√</option>
                                               ...
                                               <option ${daily_check.security_door==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    ...
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">互锁装置:</div>
								     <select disabled="true" id="interlock" name="interlock" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${daily_check.interlock==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">停止中操作</span></div>
								    ...
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">${daily_check.bench_name=='HSM'?'气管':'油管'}:</div>
								     <select disabled="true" id="pipeline" name="pipeline" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${daily_check.pipeline==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								   ...
								   <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">油盘:</div>
								     <select disabled="true" id="lacquer_tray" name="lacquer_tray" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                              <option ${daily_check.lacquer_tray==1?'selected':''} value='1'>√</option>
                                               ...
                                               <option ${daily_check.lacquer_tray==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								   ...
								   <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">台架清洁度:</div>
								     <select disabled="true" id="cleanliness_of_bench" name="cleanliness_of_bench" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${daily_check.cleanliness_of_bench==4?'selected':''} value='4'>○</option>
	                                 </select>  
								    <div style="padding-top:10px;">
								    	<div>点检方法：<span style="margin-left:5%;">停止中目视</span></div>
								   ...
								   <div class="form-group">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;position: relative;top: 10px;">${daily_check.bench_name=='HSM'?'氧浓度传感器<br/>(一年一检)':'油雾/泄漏传感器<br/>(半年一检)'}:</div>
								     <select disabled="true" id="oil_mist" name="oil_mist" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
