...
<body>
	...
	<div id="main">
		...
		<div id="main1"
			style="width:80%;margin: 0 auto;height: 70vh;margin-top: 7vh"></div>
					...
					*/
					...
					myChart1.on('click', function(param) {
						if (param.componentType == "xAxis") {
							...
							alert(param.color);
							alert(param.value);
							alert(param.userDefined);            alert("单击了" + param.value + "x轴标签");
							param.color = "#999999";
							myChart1.setOption();
						} else {
							console.log(param);
							alert(param.color);
							alert(param.value);
							alert(param.userDefined);            alert("单击了" + param.name + "柱状图");
							param.color = "#999999";
							myChart1.setOption();
