...
%>
<%
String abnormal = (String)request.getAttribute("abnormal");         // 获取错误属性
if(abnormal != null) {
%>
<script type="text/javascript" language="javascript">
alert("该订单异常");                                            // 弹出错误信息

window.location='/EPD/main/allOrderList.do' ;                            // 跳转到登录界面
</script> 
<%
}
%>
						...
						<form class="form-horizontal " id="formId">
							...
							<div class="row"
								...
								<div class="col-md-5 col-lg-5 col-xl-5 col-sm-5"
									...
									<input id="va_no" name="va_no"
											style="width: 70%; margin-left: 5%; display: inline-block;"
											class="form-control" readonly="readonly" value="${work_order.va_no}"/>
									...
									<div class="form-group" style="margin-bottom: 0px;">
										...
										<select id="kb_no" name="kb_no"
											...
											<option value='-1'>请选择KB No</option>
											 <c:if test="${fn:length(kb_recordList)!=0}">
											<c:forEach items="${kb_recordList}" var="item" >
												<option value='${item.kb_no}'>${item.kb_no}</option>
										     	</c:forEach>
											</c:if>
									...
									<div class="form-group" style="margin-bottom: 0px;">
										...
										<input id="type" name="type"
											style="width: 70%; margin-left: 5%; display: inline-block;"
											class="form-control" readonly="readonly" value="${work_order.type}"/>
									</div>
									<div class="form-group" style="margin-bottom: 0px;">
										...
										<input id="part_no" name="part_no"
											style="width: 70%; margin-left: 5%; display: inline-block;"
											class="form-control"  readonly="readonly" value="${work_order.part_no}"/>
									...
									<div class="form-group" style="margin-bottom: 0px;" id="bm">
										...
										<input id="bm_no" name="bm_no"
											style="width: 70%; margin-left: 5%; display: inline-block;"
											class="form-control" readonly="readonly" value="${work_order.bm_no}" />
									</div>
									...
									<div class="form-group" style="margin-bottom: 0px;">
										...
										<!-- <input id="work_center" name="work_center"
											...
											style="width: 70%; margin-left: 5%; display: inline-block;"
											class="form-control"  readonly="readonly" value="${work_order.work_center}" >
									...
									<div class="form-group" style="margin-bottom: 0px;">
										...
										<input id="customer_project" name="customer_project"
											style="width: 70%; margin-left: 5%; display: inline-block;"
											class="form-control" readonly="readonly" value="${work_order.customer_project}"  />
									</div>
