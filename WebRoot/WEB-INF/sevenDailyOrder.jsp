...
%>	
	...
	<div id="main">
			<div id="lantiao" style="display: flex;flex-direction:column;justify-content:center"><div style="color: white;font-size:1.2vw;margin-left:2%;">Overtime Order</div></div>
			<div class="">
		...
		<div class="box" style="border:solid #e0e0e2 1px;min-width: 1350px;" >	
			...
			<div class="s-ctn jianbian1" style="height:70px;margin-left:150px;">	
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${one}
				</div>
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${two}
				</div>
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${three}
				</div>
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${four}
				</div>
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${five}
				</div>
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${six}
				</div>
				<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;">${seven}
				</div>
			</div>
					...
					<div class="innerbox" style="height:82px;width:145px;border:solid 1px #a9aaab;margin:0 auto;overflow: scroll;">
						<c:if test="${fn:length(item.kbList.one)>0}">
							<c:forEach items="${item.kbList.one}" var="one1" >
								<%-- <p style="display:block;color:#649dfc;">${one1}</p> --%>
				...
				<div style="width:12%;min-width:150px;height:100px;padding-top:8px;margin-right: 10px;text-align:center;">
					<div class="innerbox" style="height:82px;width:145px;border:solid 1px #a9aaab;margin:0 auto;overflow: scroll;">
							...
							<c:forEach items="${item.kbList.two}" var="two2" >
								<%-- <p style="display:block;color:#649dfc;">${two2}</p> --%>
				...
				<div style="width:12%;min-width:150px;height:100px;padding-top:8px;margin-right: 10px;text-align:center;">
					<div class="innerbox" style="height:82px;width:145px;border:solid 1px #a9aaab;margin:0 auto;overflow: scroll;">
							...
							<c:forEach items="${item.kbList.three}" var="three3" >
								<%-- <p style="display:block;color:#649dfc;">${three3}</p> --%>
			...
			<div style="width:12%;min-width:150px;height:100px;padding-top:8px;margin-right: 10px;text-align:center;">
					<div class="innerbox" style="height:82px;width:145px;border:solid 1px #a9aaab;margin:0 auto;overflow: scroll;">
							...
							<c:forEach items="${item.kbList.four}" var="four4" >
								<%-- <p style="display:block;color:#649dfc;">${four4}</p> --%>
				...
				<div style="width:12%;min-width:150px;height:100px;padding-top:8px;margin-right: 10px;text-align:center;">
					<div class="innerbox" style="height:82px;width:145px;border:solid 1px #a9aaab;margin:0 auto;overflow: scroll;">
							...
							<c:forEach items="${item.kbList.five}" var="five5" >
								<%-- <p style="display:block;color:#649dfc;">${five5}</p> --%>
...
<!-- 跳转隐藏form表单 -->
	...
	function searchs(){
		...
		if(str==null||str==''){
			...
			$.ajax({
		   	url:'<%=basePath%>main/searchSevenSelectopeter.do',
			type: "POST",
			dataType:'json',
			data:	{str:str
					},
 ...
 function sevenDay(result){
		...
		html.push('<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;"id="fiveId">'+result.six+'</div>');
		html.push('<div style="width:12%;min-width:150px;height:70px;font-size: 20px;font-weight: bold;margin-right: 10px;text-align: center;line-height:70px;"id="fiveId">'+result.seven+'</div>');
		html.push('</div></div>');
		if(list.length>0){
