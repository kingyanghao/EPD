	...
	<!-- 主体内容 -->
        ...
        <!-- 蓝条  style="-webkit-appearance: none;"-->
   		<div id="lantiao" style="display: flex;flex-direction:column;justify-content:center"><div style="color: white;font-size:1.2vw;margin-left:2%;">Other equipment</div></div>
    		<form action="/EPD/celianggongju/xiugaiCe.do"id="ttt1">
			...
			<input  style="height: 3.5vh;width: 19.2%;border: 0px;color: #a2a9b4" name="taijiamingcheng" value="${celianggongju.gongjumingcheng}" readonly="readonly">
			<input type="hidden" value="${celianggongju.id}" name="id">
			...
			<c:choose>
				<c:when test="${celianggongju.gongjuzhuangtai==0}">
					<span style="height: 3.5vh;width: 19.2%;border: 0px;color: #a2a9b4;">OK</span>
		...
		<div style="margin-left:20%;margin-top: 8vh;">
			...
			<select  class="in" style="height: 3.5vh;width: 19.2%;color: #a2a9b4" name="gongjuzhuangtai">
