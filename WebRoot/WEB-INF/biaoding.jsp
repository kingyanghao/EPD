	...
	<!-- 主体内容 -->
      <div id="main">
        <!-- 蓝条  style="-webkit-appearance: none;"-->
   		<div id="lantiao" style="display: flex;flex-direction:column;justify-content:center"><div style="color: white;font-size:1.2vw;margin-left:2%;">Calibration</div></div>
   		<div>
   		<img alt="" src="/EPD/image/biaoding.png" width="100%">
   		</div>
	 </div>
</body>
<script>
