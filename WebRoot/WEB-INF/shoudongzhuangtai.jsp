	...
	<!-- 主体内容 -->
        ...
        <!-- 蓝条  style="-webkit-appearance: none;"-->
   		<div id="lantiao" style="display: flex;flex-direction:column;justify-content:center"><div style="color: white;font-size:1.2vw;margin-left:2%;">Hand gauge</div></div>
    		<form action="/EPD/shoudongliangju/xiugaiShou.do"id="ttt1">
			...
			<input  style="height: 3.5vh;width: 19.2%;border: 0px;color: #a2a9b4" name="taijiamingcheng" value="${shoudong.liangjumingcheng}" readonly="readonly">
			<input type="hidden" value="${shoudong.id}" name="id">
			...
			<c:choose>
				<c:when test="${shoudong.liangjuzhuangtai==0}">
					<span style="height: 3.5vh;width: 19.2%;border: 0px;color: #a2a9b4;">Available</span>
					<span class="iconfont icon-zhengque" style="color:#219b3e ;font-size: 1.5vw;vertical-align: middle;"></span>				
										</c:when>
				<c:when test="${shoudong.liangjuzhuangtai==1}">
					<span style="height: 3.5vh;width: 19.2%;border: 0px;color: #a2a9b4;">On Calibration</span>
					<span class="iconfont icon-yingyongchengxu-zhis" style="color:#ffc37d ;font-size: 1.5vw;vertical-align: middle;"></span>
				</c:when>
				<c:otherwise>
					<span style="height: 3.5vh;width: 19.2%;border: 0px;color: #a2a9b4;">Down</span>
					<span class="iconfont icon-yingyongchengxu-zhishe-weibaoweixiu" style="color:#d55b5b ;font-size: 1.5vw;vertical-align: middle;"></span>
				</c:otherwise>
			</c:choose>
			</div>
		<div style="margin-left:20%;margin-top: 8vh;">
			...
			<select  class="in" style="height: 3.5vh;width: 19.2%;color: #a2a9b4" name="liangjuzhuangtai">
				<option value="0">OK</option>
				<option value="1">On Calibration</option>
