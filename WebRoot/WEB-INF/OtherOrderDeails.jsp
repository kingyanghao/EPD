						...
						<form class="form-horizontal" id="formId">
							...
							<div class="row"
								...
								<div class="col-md-5 col-lg-5 col-xl-5 col-sm-5"
									...
									<div class="form-group" style="margin-bottom: 0px;">
										<div
											style="height: 38px; text-align: left; width: 30%;white-space: nowrap; display: inline-block; color: #606265;">Plan
											work hours:</div>
									...
									<div class="form-group" style="border-bottom: solid 1px #d2c3c3;">
										...
										<div
											...
											<div style="width: 20%; display: inline-block;">
												...
												<input type="checkbox" id="inlineCheckbox1"  ${work_order.one_point1==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="one_point1">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">Parts deliver:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point2==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="one_point2">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">Pick up:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point3==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="one_point3">
											</div>
										</div>
										...
										<div
											...
											<div style="width: 20%; display: inline-block;">
												...
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point4==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="one_point4">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">Mechanic Support:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point5==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="one_point5">
											</div>
											<div style="width: 20%; display: inline-block;">
												<div style="display: inline-block;width: 70%;">Scrap:</div>
												<input type="checkbox" id="inlineCheckbox1" ${work_order.one_point6==1?'checked':''} disabled="disabled"
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="" name="one_point6">
											</div>
										</div>
