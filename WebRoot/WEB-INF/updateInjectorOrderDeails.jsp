								...
								<div class="col-md-5 col-lg-5 col-xl-5 col-sm-5"
									...
									<div class="form-group"  style="margin-bottom: 0px;" id="dead">
										...
										<input id="deadline" name="deadline" 
											style="width: 60%; margin-left: 5%; display: inline-block;"
											class="form-control" readonly  value="${work_order.deadline}"/>
									</div>
									...
									<div class="form-group" style="border-bottom: solid 1px #d2c3c3;">
										<div
											...
											<span style="margin-left: 5%;">Repat</span>
												<select  name="injector_round" style="margin-left: 1%;height: 28px; width: 30%;  display: inline-block; padding: 0px 0px;" class="form-control">');	
												<option  ${work_order.injector_round==1?'selected':''} value="1">1</option><option  ${work_order.injector_round==2?'selected':''} value="2">2</option><option ${work_order.injector_round==3?'selected':''} value="3">3</option>
												<option  ${daily_check.injector_round==4?'selected':''} value="4">4</option><option  ${work_order.injector_round==5?'selected':''} value="5">5</option><option ${work_order.injector_round==6?'selected':''} value="6">6</option>
												<option  ${work_order.injector_round==7?'selected':''} value="7">7</option><option  ${work_order.injector_round==8?'selected':''} value="8">8</option><option ${work_order.injector_round==9?'selected':''}  value="9">9</option>
												<option  ${work_order.injector_round==10?'selected':''} value="10">10</option><option  ${work_order.injector_round==11?'selected':''} value="11">11</option><option ${work_order.injector_round==12?'selected':''} value="12">12</option>
												<option   ${work_order.injector_round==13?'selected':''} value="13">13</option><option  ${work_order.injector_round==14?'selected':''} value="14">14</option><option ${work_order.injector_round==15?'selected':''} value="15">15</option>
												<option  ${work_order.injector_round==20?'selected':''} value="20">20</option></select>
										</div>
										<div
											...
											<div style="width: 20%; display: inline-block;">
												...
												<input type="checkbox" id="inlineCheckbox1" ${work_order.five_point1==1?'checked':''} 
													...
													<select  name="injector_test_point_round" style="margin-left: 5%;height: 28px; width: 30%;  display: inline-block; padding: 0px 0px;" class="form-control">');	
												<option  ${work_order.injector_test_point_round==1?'selected':''} value="1">1</option><option  ${work_order.injector_test_point_round==2?'selected':''} value="2">2</option><option ${work_order.injector_test_point_round==3?'selected':''} value="3">3</option>
												<option  ${daily_check.injector_test_point_round==4?'selected':''} value="4">4</option><option  ${work_order.injector_test_point_round==5?'selected':''} value="5">5</option><option ${work_order.injector_test_point_round==6?'selected':''} value="6">6</option>
												<option  ${work_order.injector_test_point_round==7?'selected':''} value="7">7</option><option  ${work_order.injector_test_point_round==8?'selected':''} value="8">8</option><option ${work_order.injector_test_point_round==9?'selected':''}  value="9">9</option>
												<option  ${work_order.injector_test_point_round==10?'selected':''} value="10">10</option><option  ${work_order.injector_test_point_round==11?'selected':''} value="11">11</option><option ${work_order.injector_test_point_round==12?'selected':''} value="12">12</option>
												<option   ${work_order.injector_test_point_round==13?'selected':''} value="13">13</option><option  ${work_order.injector_test_point_round==14?'selected':''} value="14">14</option><option ${work_order.injector_test_point_round==15?'selected':''} value="15">15</option>
												<option  ${work_order.injector_test_point_round==20?'selected':''} value="20">20</option></select>
											</div>
											<div style="width: 20%; display: inline-block;">
										...
										<div
											...
											<select  name="injector_num" style="margin-left: 5%;height: 28px; width: 30%;  display: inline-block; padding: 0px 0px;" class="form-control">');	
												<option  ${work_order.injector_num==1?'selected':''} value="1">1</option><option  ${work_order.injector_num==2?'selected':''} value="2">2</option><option ${work_order.injector_num==3?'selected':''} value="3">3</option>
												<option  ${daily_check.injector_num==4?'selected':''} value="4">4</option><option  ${work_order.injector_num==5?'selected':''} value="5">5</option><option ${work_order.injector_num==6?'selected':''} value="6">6</option>
												<option  ${work_order.injector_num==7?'selected':''} value="7">7</option><option  ${work_order.injector_num==8?'selected':''} value="8">8</option><option ${work_order.injector_num==9?'selected':''}  value="9">9</option>
												<option  ${work_order.injector_num==10?'selected':''} value="10">10</option><option  ${work_order.injector_num==11?'selected':''} value="11">11</option><option ${work_order.injector_num==12?'selected':''} value="12">12</option>
												<option   ${work_order.injector_num==13?'selected':''} value="13">13</option><option  ${work_order.injector_num==14?'selected':''} value="14">14</option><option ${work_order.injector_num==15?'selected':''} value="15">15</option>
												<option  ${work_order.injector_num==20?'selected':''} value="20">20</option></select>
											...
											<div style="width: 35%; display: inline-block;">
												...
												<input type="checkbox" id="inlineCheckbox1" ${work_order.five_point8==1?'checked':''} 
													style="height: 18px; width: 18px; position: relative; top: 3px; left: 10px;"
													value="1" name="five_point8"> 
												<%-- 	<input 
													name="injector_time" 
													style="height: 28px; width: 30%; margin-left: 5%; display: inline-block; padding: 0px 0px;"
													class="form-control" value="${work_order.injector_time}"/> --%>
													<select  name="injector_time" style="margin-left: 5%;height: 28px; width: 30%;  display: inline-block; padding: 0px 0px;" class="form-control">');	
												<option  ${work_order.injector_time=='Dry'?'selected':''} value="Dry">Dry</option>
												<option  ${work_order.injector_time=='Wet'?'selected':''} value="Wet">Wet</option>
												</select>
											</div>
										</div>
									</div>
