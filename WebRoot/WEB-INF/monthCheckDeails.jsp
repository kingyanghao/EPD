							...
							<div class="col-md-8 col-lg-8 col-xl-8 col-sm-8" style="min-height:30px;border:saolid 1px;">
								 <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">废油箱排空:</div>
								     <select disabled="true" id="m_01" name="m_01" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${month_check.m_01==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">回油滤芯更换:</div>
								     <select disabled="true" id="m_02" name="m_02" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
								  ...
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">回油连接头密封圈检查（破损更换）:</div>
								     <select disabled="true" id="m_03" name="m_03" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${month_check.m_03==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">EMI内腔清洗:</div>
								     <select disabled="true" id="m_04" name="m_04" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${month_check.m_04==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
								  
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">EMI密封垫片检查（破损更换）:</div>
								     <select disabled="true" id="m_05" name="m_05" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${month_check.m_05==4?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
							</div>
							<div class="col-md-2 col-lg-2 col-xl-2 col-sm-2" style="min-height:30px;"></div>
								  ...
								  <div class="form-group" style="margin-bottom:0px;">
								    <div style="height:38px;width:30%;display: inline-block;color:#919aa7;">HDA排空阀清洗:</div>
								     <select disabled="true" id="m_05" name="m_05" style="width:50%;margin-left:5%;display: inline-block;" class="form-control">
                                               ...
                                               <option ${month_check.m_01==5?'selected':''} value='4'>○</option>
	                                 </select>  
								  </div>
							</div>
							<div class="col-md-2 col-lg-2 col-xl-2 col-sm-2" style="min-height:30px;"></div>
