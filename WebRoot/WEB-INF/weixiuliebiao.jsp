...
{{# if(d.guandanshijian==null||d.guandanshijian==''){ }}
  <a class="layui-btn layui-btn-xs" style="background-color:#f0ad4e" lay-event="guan">Open</a>
{{#  } else { }}
  <a class="layui-btn layui-btn-xs"  style="background-color:#808080">Colse</a>
	{{#  } }}
</script>
