		...
		<table style="margin-top:1.5vh;width: 100%;height:11.3vh ;vertical-align:middle" >
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=CI4000 F1">Status</option>
				</select>
			</td>
			</tr>
		</table>
		...
		<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=CI4000 F2">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=CI4000 F3">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=CI4000 F4">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=ESS F6">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=CI4000-RAK F7">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=ESS F8(NEW)">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=Large engine F9">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=Nozzle flow rate">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=Nozzle Pdoe">Status</option>
				</select>
			</td>
			</tr>
		</table>
...
<form action="" style="display: inline-block;">
			...
			<td ALIGN="RIGHT" colspan="5">
				<select  style="-webkit-appearance: none;width:10px;border:0px;background-image:url('/EPD/image/444.png');background-size:90%;background-repeat: no-repeat;" onchange="s_click(this)">
					...
					<option value="/EPD/main/dailyCheck.do">Daily Check</option>
					<option value="/EPD/main/benchOrder.do">Daily Work</option>
					<option value="/EPD/taijia/zhuangtai.do?taijiamingcheng=HSM">Status</option>
				</select>
			</td>
			</tr>
		</table>
