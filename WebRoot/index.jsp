...
<div class="  child1" style="height: 100px;">
        ...
        <div class="one_css outline child">
                ...
                <div style="text-align: center;margin-left: 3%;margin-right: 3%;min-height: 100px;">
                    <input type="text" id="account" name="account" placeholder="Account" maxlength="20" style="height: 60px;width:100%;padding-left: 10px;padding-right: 10px;border-radius: 10px;margin-top: 10px;">
                     <input onfocus="this.type='password'" type="text" id="password" name="password" placeholder="Password" maxlength="15" style="height: 60px;width:100%;padding-left: 10px;padding-right: 10px;border-radius: 10px;margin-top: 10px;">
                    </div>
